...
default_date_after_2_month = (today + dt.timedelta(days=60)).date()             # default dates mainly for streamlit date selector
recursive_date = st.sidebar.date_input('Provide a recursive_date', value= default_date_after_2_month)
