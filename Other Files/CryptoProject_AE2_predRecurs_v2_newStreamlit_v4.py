...
title_format = f'<p style="text-align: center; font-family: ' \
               f'Arial; color: #FF9900; font-size: 50px; ' \
...
def predict(dt0, dt1):
    ...
    #print('Prediction and Actual Prices for ' + crypto_coin + ' from ' + str(dt0) + ' to ' + str(dt1) + ' as following:')
    st.header('Regualr/Non-Recursive Prediction and Actual Prices for ' + crypto_coin + ' from ' + str(dt0) + ' to ' + str(dt1) + ' as following:')
...
def recursive_predict1(dt4,dt2):
    ...
    st.header('Recursive Predictions and Actual Prices for ' + crypto_coin + ' from ' + str(dt4) + ' to ' + str(dt2) + ' as following:')
...
def recursive_predict2(dt4,dt2):
    ...
    st.header('Recursive Predictions, Regular/Non-Recursive Predictions and Actual Prices for ' + crypto_coin + ' from ' + str(dt4) + ' to ' + str(dt2) + ' as following:')
...
default_date_before_3_month = (today - dt.timedelta(days=90))              # default dates mainly for streamlit date selector
default_date_after_2_month = (today + dt.timedelta(days=60))
start_date = st.sidebar.date_input('[Graph1] : Provide a start_date', value= default_date_before_3_month) 
end_date = st.sidebar.date_input('[Graph1] : Provide a end_date', value= default_date_after_2_month) 
start_date = default_date_before_3_month.strftime("%Y-%m-%d")
end_date = default_date_after_2_month.strftime("%Y-%m-%d")
...
today = dt.datetime.now()
default_date_before_4_month = (today - dt.timedelta(days=120))            # default dates mainly for streamlit date selector
default_date_before_2_month = (today - dt.timedelta(days=60)) 
pred_start_date = st.sidebar.date_input('[Graph2] : Provide a pred_start_date', value= default_date_before_4_month) 
pred_end_date = st.sidebar.date_input('[Graph2] : Provide a pred_end_date', value= default_date_before_2_month) 
pred_start_date = default_date_before_4_month.strftime("%Y-%m-%d") 
pred_end_date = default_date_before_2_month.strftime("%Y-%m-%d") 
...
today = dt.datetime.now()
default_date_after_4_month = (today + dt.timedelta(days=120))             # default dates mainly for streamlit date selector
recursive_date_start = st.sidebar.date_input('[Graph3] : Provide a recursive_start_date', value= today_plus_one) 
recursive_date_end = st.sidebar.date_input('[Graph3] : Provide a recursive_end_date', value= default_date_after_4_month) 
recursive_date_start = today_plus_one.strftime('%Y-%m-%d')
recursive_date_end = default_date_after_4_month.strftime("%Y-%m-%d")
